    ...
    Program: {
      enter(path, state) {
        ...
        if (runtime === "classic") {
          ...
          state.set("@babel/plugin-react-jsx/jsxIdentifier", createImportLazily(state, path, options.development ? "jsxDEV" : "jsx", source));
          state.set("@babel/plugin-react-jsx/jsxStaticIdentifier", createImportLazily(state, path, options.development ? "jsxDEV" : "jsxs", source));
          state.set("@babel/plugin-react-jsx/createElementIdentifier", createImportLazily(state, path, "createElement", source));
          state.set("@babel/plugin-react-jsx/jsxFragIdentifier", createImportLazily(state, path, "Fragment", source));
  ...
  function createImportLazily(pass, path, importName, source) {
    return () => {
      ...
      if ((0, _helperModuleImports.isModule)(path)) {
        let reference = pass.get(`@babel/plugin-react-jsx/imports/${importName}`);
        ...
        let reference = pass.get(`@babel/plugin-react-jsx/requires/${actualSource}`);
        ...
        if (reference) {
          ...
          pass.set(`@babel/plugin-react-jsx/requires/${actualSource}`, reference);
        }
