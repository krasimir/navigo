...
/***/ function(module, exports) {
	...
	function extractGETParameters(url) {
	  ...
	  var onlyURL = _url$split2[0];
	
	  var query = _url$split2.slice(1);
	...
	Navigo.prototype = {
	  ...
	  resolve: function resolve(current) {
	    ...
	    var _extractGETParameters = extractGETParameters(url);
	
	    var onlyURL = _extractGETParameters.onlyURL;
	    var GETParameters = _extractGETParameters.GETParameters;
	    ...
	    if (m) {
	      ...
	      manageHooks(function () {
	        _this2._lastRouteResolved = onlyURL;
	  ...
	  _add: function _add(route) {
	    ...
	    var hooks = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];
