...
function Navigo(r) {
  ...
  var notFoundLifeCycle = [_checkForNotFoundHandler, [function (context) {
    return context.notFoundHandled;
  }, lifecycle, [_errorOut]]];
  ...
  function resolve(currentLocationPath) {
    ...
    (0,_Q__WEBPACK_IMPORTED_MODULE_1__.default)([_setLocationPath, _findAMatch, _Q__WEBPACK_IMPORTED_MODULE_1__.default.if(function (context) {
  ...
  function navigate(to, options) {
    ...
    (0,_Q__WEBPACK_IMPORTED_MODULE_1__.default)([_checkForSilentMode, _Q__WEBPACK_IMPORTED_MODULE_1__.default.if(function (_ref) {
      var shouldResolve = _ref.options.shouldResolve;
      return typeof shouldResolve === "undefined" || shouldResolve === true;
    }, [_findAMatch, _Q__WEBPACK_IMPORTED_MODULE_1__.default.if(function (_ref2) {
      var match = _ref2.match;
      return match;
    }, lifecycle, notFoundLifeCycle), _updateBrowserURL], _updateBrowserURL)], context);
  }
