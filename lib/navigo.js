...
/***/ function(module, exports, __webpack_require__) {
	...
	function Navigo(r, useHash) {
	  this._routes = [];
	  this.root = r || null;
	  this._isHistorySupported = !useHash && !!(typeof window !== 'undefined' && window.history && window.history.pushState);
	...
	Navigo.prototype = {
	  ...
	  _addRoute: function _addRoute(route) {
	  ...
	  _getRoot: function _getRoot() {
	    ...
	    this.root = (0, _URLParse.root)(this._getCurrentWindowLocation(), this._routes);
	    return this.root;
	  },
	  _listenForURLChanges: function _listenForURLChanges() {
	    var _this = this;
	    ...
	    if (this._isHistorySupported) {
	      ...
	      (function () {
	        var cached = _this._getCurrentWindowLocation(),
	            current = undefined,
	            check = undefined;
	
	        check = function () {
	          current = _this._getCurrentWindowLocation();
	          if (cached !== current) {
	            cached = current;
	            _this.resolve();
	          }
	  ...
	  _getCurrentWindowLocation: function _getCurrentWindowLocation() {
