...
function checkForLeaveHook(context, done) {
  ...
  (0,_Q__WEBPACK_IMPORTED_MODULE_0__.default)([].concat(instance.lastResolved().map(function (oldMatch) {
    return function (_, leaveLoopDone) {
      ...
      if ((0,_utils__WEBPACK_IMPORTED_MODULE_1__.undefinedOrTrue)(context.navigateOptions, "callHooks") && (!context.match || !instance.matchLocation(oldMatch.route.path, context.match.url))) {
